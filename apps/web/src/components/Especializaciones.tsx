...
const Especializaciones: React.FC = () => {
  ...
  <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="text-center mb-10">
          ...
          <h2 className="mb-8" style={{fontFamily: 'Bebas Neue, sans-serif', fontSize: '45px', fontWeight: 400}}>ESTE EQUIPO DE ARQUITECTOS SE ESPECIALIZA EN:</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {especializaciones.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 text-white py-3 px-2 text-center z-10" style={{fontFamily: 'Bebas Neue, sans-serif', letterSpacing: 1, fontSize: '30px', fontWeight: 400}}>
                {item.title}
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6 pt-8">
                <div className="flex-1 order-2 md:order-1">
                  <div className="text-[#b35427] mb-2" style={{fontFamily: 'Bebas Neue, sans-serif', fontWeight: 400, fontSize: '28px'}}>{paso.numero}</div>
                   <h3 className="mb-2 whitespace-pre-line" style={{fontFamily: 'Bebas Neue, sans-serif', fontWeight: 400, fontSize: '36px', lineHeight: 1.1}}>{paso.titulo}</h3>
